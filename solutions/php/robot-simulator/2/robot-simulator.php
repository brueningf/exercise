...
class Robot {
    ...
    {
        if(count($position) !== 2) throw new InvalidArgumentException('Invalid position');
        if(!in_array($direction, $this->directions)) throw new InvalidArgumentException('Invalid direction');
